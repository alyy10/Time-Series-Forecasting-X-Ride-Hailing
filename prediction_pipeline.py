...
def main():
    ...
    df = pd.read_csv('../Data/test_dataset/cleaned_test_booking_data.csv',
    ...
    data_without_lag.to_csv(
        '../Data/test_dataset_prediction_output/prediction_without_lag_model.csv', index=False, compression='gzip')
    ...
    data_with_lag.to_csv(
        '../Data/test_dataset_prediction_output/prediction_with_lag_model.csv', index=False, compression='gzip')
